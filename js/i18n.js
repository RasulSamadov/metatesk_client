...
const translations = {
    en: {
        ...
        // Product
        'prod.tag': 'Product',
        'prod.title': 'Three pillars.<br><span class="grad">One platform.</span>',
        ...
        'how.s3.text': 'The intelligent guide explains, adapts, answers questions, and ensures deep understanding at each student\'s pace.',
        ...
        'faq.a1': 'Metatesk is not just content delivery. It combines immersive VR environments, multiplayer interaction, and institutional-grade LMS infrastructure in one platform. Students don\'t watch — they step inside.',
        ...
        // Footer
        'footer.tagline': 'Metatesk builds immersive VR learning worlds. Founded by <a href="/gunay-imanzade" class="footer-founder-link">Gunay Imanzade</a> — Forbes 30 Under 30 Europe.',
        'footer.copy': '© 2026 Metatesk. All rights reserved.',

        // ── Product page ──────────────────────────────────────────────────
        'prod.page.tag': 'Platform',
        'prod.page.sub': 'Metatesk combines immersive VR environments, real-time multiplayer classrooms, and institutional LMS infrastructure into a single cohesive platform — built to transform education from the ground up.',
        'prod.page.cta2': 'See Solutions',
        'prod.p1.tag': 'Pillar 01',
        'prod.p2.tag': 'Pillar 02',
        'prod.p3.tag': 'Pillar 02',
        'prod.p4.tag': 'Pillar 03',
        ...
        'prod.cta.sub': 'Metatesk is ready for schools, institutions, and governments. Request a live demo and see all three pillars working together in a real session.',
        ...
        'sol.students.p2': 'With multiplayer classrooms that make learning social, students engage with material in ways that genuinely build understanding.',
        ...
        'sol.educators.feat2.sub': 'AI answers routine student questions so you don\'t have to',
        ...
        'gunay.bio.p2': 'In 2021, Gunay founded Metatesk — an immersive VR and AI education platform built for the way students actually learn. The platform combines virtual reality classrooms, multiplayer sessions for up to 30 students, and an institutional-grade LMS capable of national-scale deployment.',
    ...
    az: {
        ...
        'prod.tag': 'Məhsul',
        'prod.title': 'Üç sütun.<br><span class="grad">Bir platforma.</span>',
        ...
        'how.s3.text': 'Ağıllı bələdçi izah edir, uyğunlaşır, suallara cavab verir.',
        ...
        'faq.a1': 'Metatesk sadəcə məzmun çatdırma deyil. İmmersiv VR mühitləri, multiplayer qarşılıqlı əlaqə və institusional LMS-i bir platformada birləşdirir.',
        ...
        'footer.tagline': '<a href="/gunay-imanzade" class="footer-founder-link">Günay İmanzadə</a> tərəfindən qurulan Metatesk, immersiv VR öyrənmə dünyaları yaradır — Forbes 30 Under 30 Avropa.',
        'footer.copy': '© 2026 Metatesk. Bütün hüquqlar qorunur.',

        // ── Product page ──────────────────────────────────────────────────
        'prod.page.tag': 'Platforma',
        'prod.page.sub': 'Metatesk immersiv VR mühitlərini, real vaxt multiplayer siniflərini və institusional LMS infrastrukturunu bir vahid platformada birləşdirir — təhsili sıfırdan dəyişdirmək üçün qurulub.',
        'prod.page.cta2': 'Həlləri Gör',
        'prod.p1.tag': 'Sütun 01',
        'prod.p2.tag': 'Sütun 02',
        'prod.p3.tag': 'Sütun 02',
        'prod.p4.tag': 'Sütun 03',
        ...
        'prod.cta.sub': 'Metatesk məktəblər, müəssisələr və hökumətlər üçün hazırdır. Canlı demo tələb edin və real sessiyada üç sütunun birlikdə işlədiyini görün.',
        ...
        'sol.students.p2': 'Öyrənməni sosial edən multiplayer siniflər ilə tələbələr həqiqətən anlayış quran şəkildə materiallarla məşğul olur.',
        ...
        'sol.educators.feat2.sub': 'Sİ rutin tələbə suallarını cavablandırır',
        ...
        'gunay.bio.p2': '2021-ci ildə Günay Metatesk-i qurdu — tələbələrin həqiqətən öyrəndiyi şəkil üçün qurulmuş immersiv VR və Sİ təhsil platforması. Platforma virtual reallıq siniflərini, 30-a qədər tələbə üçün multiplayer sessiyaları və milli miqyaslı yerləşdirməyə qadir institusional səviyyəli LMS-i birləşdirir.',
